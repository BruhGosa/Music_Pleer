...
procedure TPleer.Button_StopClick(Sender: TObject);
begin
...
procedure TPleer.Button_LastClick(Sender: TObject);
begin
...
procedure TPleer.Button_Add_FileClick(Sender: TObject);
var
  i:Integer;
begin
...
procedure TPleer.Button_NextClick(Sender: TObject);
begin
  //
...
procedure TPleer.FormClose(Sender: TObject; var CloseAction: TCloseAction);
begin
...
procedure TPleer.FormCreate(Sender: TObject);
begin
...
procedure TPleer.Play_ListClick(Sender: TObject);
begin
  //
...
procedure TPleer.Scroll_Bar_MusicScroll(Sender: TObject;
...
procedure TPleer.Timer1Timer(Sender: TObject);
var
